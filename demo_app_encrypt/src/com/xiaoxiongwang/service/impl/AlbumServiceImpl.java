...
import com.xiaoxiongwang.service.AlbumService;
...
public class AlbumServiceImpl extends ICommServiceImpl implements AlbumService {
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getMyPhotoList(int, int)
	 */
	@Override
...
//				}
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#delMyPhoto(int)
	 */
	@Override
	 ...
	 * 获取用户相册(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.AlbumService#getMyAnnualAlbum(int, int)
	 */
	@Override
