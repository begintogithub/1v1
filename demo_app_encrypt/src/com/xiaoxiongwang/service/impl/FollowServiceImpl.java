...
import com.xiaoxiongwang.service.FollowService;
...
public class FollowServiceImpl extends ICommServiceImpl implements
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.FollowService#getFollowList(int, int)
	 */
	@Override
	 ...
	 * 添加关注 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.FollowService#saveFollow(int, int)
	 */
	@Override
	...
	/*
	 * 删除关注(non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.FollowService#delFollow(int)
	 */
	@Override
	 ...
	 * @see com.xiaoxiongwang.service.FollowService#getSpecifyUserFollow(int, int)
	 */
	@Override
