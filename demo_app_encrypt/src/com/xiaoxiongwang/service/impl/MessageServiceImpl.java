...
public class MessageServiceImpl extends ICommServiceImpl implements
	 ...
	 * 统计未读消息数
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.MessageService#getUnreadMessage(int)
	 */
	@Override
	 ...
	 * 分页获取消息列表
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.MessageService#getMessageList(int, int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.MessageService#setupRead(int)
	 */
	@Override
	...
	/*
	 * 删除消息(non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.MessageService#delMessage(int)
	 */
	@Override
	 ...
	 * 发送消息
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.MessageService#pushMessage(com.xiaoxiongwang.domain.MessageEntity)
	 */
	@Override
