...
import com.xiaoxiongwang.service.MoneyService;
...
public class MoneyServiceImpl extends ICommServiceImpl implements  MoneyService {
	...
	/*
	 * 查询个人钱包(non-Javadoc)
	 * @see com.xiaoxiongwang.service.MoneyService#getUserMoney(int)
	 */
	@Override
...
//			//得到金币 
	 ...
	 * 查询用户个人余额
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.MoneyService#getQueryUserBalance(int)
	 */
	@Override
	 ...
	 * 获取提现折扣
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.MoneyService#getPutforwardDiscount()
	 */
	@Override
	 ...
	 * 获取充值折扣
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.app.MoneyService#getRechargeDiscount()
	 */
	@Override
	...
	public synchronized MessageUtil confirmPutforward(int dataId, int userId,int putForwardId) {
		try {
			...
			if(!putTime.isEmpty() && putTime.get(0).get("putdate").toString().equals(DateUtils.format(new Date(), "YYYY-MM-dd"))){
	...
	/*
	 * 获取可提现金额(non-Javadoc)
	 * @see com.xiaoxiongwang.service.MoneyService#getUsableGold(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.xiaoxiongwang.service.MoneyService#modifyPutForwardData(int, java.lang.String, java.lang.String, int)
	 */
	@Override
			...
			queryList.forEach(s ->{
				...
				case WalletDetail.CHANGE_CATEGOR_RECOMMENDATION: //推荐分成
					 ...
					 List<Map<String,Object>> sqlList = this.
					         getQuerySqlList("SELECT u.t_nickName,u.t_phone,u.t_handImg FROM t_redpacket_log r LEFT JOIN t_user u ON t_hair_userId = u.t_id  WHERE t_redpacket_id = ? AND r.t_redpacket_type = 1;",
							 s.get("t_sorece_id"));
