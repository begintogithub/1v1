...
import com.xiaoxiongwang.domain.VideoSignature;
...
import com.xiaoxiongwang.util.AcThread;
import com.xiaoxiongwang.util.DateUtils;
import com.xiaoxiongwang.util.KeyWordUtil;
...
public class PersonalCenterServiceImpl extends ICommServiceImpl implements PersonalCenterService {
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getWalletDetail(int, int,
	 * java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.xiaoxiongwang.service.app.PersonalCenterService#getUserIsIdentification(int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#submitData(int,
...
//				}			
	 ...
	 * 统计贡献值 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getUserShareCount(int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getShareUserList(int, int)
	 */
	@Override
	 ...
	 * 获取潜水列表 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getDivingUserList(int, int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getPersonalData(int)
	 */
	@Override
	public MessageUtil getPersonalData(int userId) {
		try {
			...
			// 获取封面
			sql = "SELECT t_img_url,t_first,t_is_examine FROM t_cover_examine WHERE t_user_id = ?  ";
	 ...
	 * 修改个人资料 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#updatePersonalData(int,
...
//			GoogleCacheUtil.userCache.invalidate(userId);
	 ...
	 * 获取标签列表 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getLabelList(int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getAnchorChargeSetup(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.xiaoxiongwang.service.app.PersonalCenterService#updateAnchorChargeSetup(int,
...
//					}
	 ...
	 * 获取礼物列表 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getGiftList(int)
	 */
	@Override
	 ...
	 * 获取分享统计 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getShareTotal(int)
	 */
	@Override
	 ...
	 * 获取我的私藏 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getMyPrivate(int, int)
	 */
	@Override
	 ...
	 * 删除我的私藏 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#delMyPrivate(int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.app.PersonalCenterService#getBrowseList(int, int)
	 */
	@Override
	...
	@SuppressWarnings("unchecked")
	@Override
	public MessageUtil saveCoverImg(int userId, String coverImg, String t_first) {
...
//					.executeSQL(upSql, t_first, userId);
	 ...
	 * 获取日明细(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#getWalletDateDetails(int,
	 ...
	 * 
	 * @see
	 * com.xiaoxiongwang.service.PersonalCenterService#updateOrDelVideo(java.lang.String ,
	 * int)
	 */
	@Override
...
//				this.getFinalDao().getIEntitySQLDAO().executeSQL(delSql, fileId);
	 ...
	 * 添加意见反馈(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#addFeedback(java.lang.String,
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#getFeedBackList(int, int)
	 */
	@Override
	 ...
	 * 用户设置勿扰(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#updateUserDisturb(int, int)
	 */
	@Override
...
//			GoogleCacheUtil.userCache.invalidate(userId);
	 ...
	 * 获取公会统计(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#getGuildCount(int)
	 */
	@Override
	 ...
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#isApplyGuild(int, int, int)
	 */
	@Override
	 ...
	 * 获取打赏列表(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#getRewardList(int, int)
	 */
	@Override
	 ...
	 * 查看主播资料 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#getAnchorData(int, int)
	 */
	@Override
	 ...
	 * 获取亲密度列表(non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.PersonalCenterService#getAnthorIntimateList(int, int)
	 */
	@Override
