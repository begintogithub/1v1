...
import com.xiaoxiongwang.domain.GetOutOfLineRes;
...
import com.xiaoxiongwang.service.ProhibitService;
...
public class ProhibitServiceImpl extends ICommServiceImpl implements ProhibitService {
	 ...
	 * @param userId
	 */
	private void handleIllegalityUser(Integer userId,String videoUrl) {
		try {
...
//						gof.setMessage(message);
	 ...
	 * IM信息处理 (non-Javadoc)
	 * 
	 * @see com.xiaoxiongwang.service.ProhibitService#handleImCallBack(int, int,
	 * java.lang.String)
	 */
	@Override
