...
import com.xiaoxiongwang.service.ActivityService;
import com.xiaoxiongwang.service.ShareService;
...
public class ShareServiceImpl extends ICommServiceImpl implements ShareService {
	...
	/*
	 * 保存设备信息(non-Javadoc)
	 * @see com.xiaoxiongwang.service.ShareService#addShareInfo(int, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/*
	 * 添加分享记录(non-Javadoc)
	 * @see com.xiaoxiongwang.service.ShareService#addShareCount(int)
	 */
	@Override
