...
public interface DynamicService {
     ...
     * @return
     */
    MessageUtil getDynamicList(int userId, int reqType, String lonlat, int page);
     ...
     * @return
     */
    MessageUtil releaseDynamic(int userId, String title, String content, String address, int isVisible, String lon, String lat, JSONArray files);
