...
import com.xiaoxiongwang.util.BodyReaderHttpServletRequestWrapper;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		if (url.indexOf("qqLogin") > 0 || url.indexOf("getVerify") > 0 || url.indexOf("getVerifyCodeIsCorrect") > 0
				...
				|| url.indexOf("upPassword") > 0 || url.indexOf("codePayCallBack") > 0
				|| url.indexOf("ZhiBoSig") > 0||url.indexOf("ZhiBoCosSig") > 0||url.indexOf("ZhiBoUploadRoom") > 0
		   ) {
