...
//	        faceLiveDetectPicture(imageClient, bucketName);//人脸静态活体检测
	     ...
	     */
	    private static void faceLiveDetectPicture(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String result=null;
	     ...
	     * 检测视频和身份证是否对上操作
	     */
	    private static void faceLiveDetectFour(ImageClient imageClient, String bucketName, String validate) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 通过视频对比指定身份信息接口
	     */
	    private static void faceIdCardLiveDetectFour(ImageClient imageClient, String bucketName, String validate) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 获取验证码接口
	     */
	    private static String faceLiveGetFour(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        System.out.println("====================================================");
	        String seq = "";
	     ...
	     * 身份证识别对比接口
	     */
	    private static void faceIdCardCompare(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 人脸对比操作
	     */
	    private static void faceFaceCompare(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     */
	    private static void faceMultiIdentifyRequest(ImageClient imageClient, String bucketName) throws AbstractImageException {
	     ...
	     * 人脸识别操作
	     */
	    private static void faceFaceIdentify(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 人脸验证操作
	     */
	    private static void faceFaceVerify(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 获取人脸信息
	     */
	    private static void faceGetFaceInfo(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 获取人脸列表
	     */
	    private static void faceGetFaceIdList(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 获取人列表
	     */
	    private static void faceGetPersonId(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 获取组列表
	     */
	    private static void faceGetGroupId(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     */
	    private static void faceDelGroupId(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 个体获取信息
	     */
	    private static void faceGetInfo(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 个体设置信息
	     */
	    private static void faceSetInfo(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 人脸删除操作
	     */
	    private static void faceDelFace(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 增加人脸操作
	     */
	    private static void faceAddFace(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 个人删除操作
	     */
	    private static void faceDelPerson(ImageClient imageClient, String bucketName, String personId) throws AbstractImageException {
	        String ret;
	        System.out.println("====================================================");
	     ...
	     * 个体添加操作
	     */
	    private static String faceNewPerson(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	     ...
	     * 五官定位操作
	     */
	    private static void faceShape(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 人脸检测操作
	     */
	    private static void faceDetect(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 名片ocr识别操作
	     */
	    private static void ocrNameCard(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 通用印刷体OCR
	     */
	    private static void ocrGeneral(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * OCR-营业执照识别
	     */
	    private static void ocrBizLicense(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * OCR-银行卡识别
	     */
	    private static void ocrBankCard(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * OCR-车牌识别
	     */
	    private static void ocrPlate(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * OCR-行驶证驾驶证识别
	     */
	    private static void ocrDrivingLicence(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. 驾驶证 url方式
	        System.out.println("====================================================");
	     ...
	     * 身份证ocr识别操作
	     */
	    private static void ocrIdCard(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式,识别身份证正面
	        System.out.println("====================================================");
	     ...
	     * 标签识别操作
	     */
	    private static void imageTag(ImageClient imageClient, String bucketName) throws AbstractImageException {
	        String ret;
	        // 1. url方式
	        System.out.println("====================================================");
	     ...
	     * 黄图识别操作
	     */
	    public static Map<String, Object> imagePorn(String[] urls,String appId,String secretId,String secretKey,String bucketName) throws AbstractImageException {
