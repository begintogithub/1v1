...
public class PayUtil {
	 ...
	 * @throws Exception
	 */
	public static String alipayCreateOrder(String orderNo, BigDecimal payAmount, String projectName,
			String alipay_appid, String alipay_private_key, String alipay_public_key) throws Exception {

		// 实例化客户端
		AlipayClient alipayClient = new DefaultAlipayClient("https://openapi.alipay.com/gateway.do",
				alipay_appid.trim(), alipay_private_key.trim(), "json", "utf-8", alipay_public_key.trim(), "RSA2");
	 ...
	 * @return
	 */
	public static Map<String, String> wxPay(String body, String orderNo, Integer money, String appId, String mchId,
			String key) {
	...
	public static String codePay(String orderNo, String body, int payType, BigDecimal price, HttpServletResponse response,
			String code_id, String code_key, String notify_url, String token) throws IOException {
		Integer type;
		if (2 == payType) {
			type = 1;
		} else if (3 == payType) {
		...
		// 参数有中文则需要URL编码
		String url = "http://codepay.fateqq.com:52888/creat_order?id=" + code_id + "&pay_id=" + orderNo + "&price="
				+ price + "&type=" + type + "&token=" + token + "&param=" + "" + "&notify_url=" + notify_url
				+ "&return_url=" + "";
