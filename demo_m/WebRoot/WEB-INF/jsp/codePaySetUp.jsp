...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">
				<button class="btn btn-default">码支付</button>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div style="height: 40px;">
							<label class="col-md-2 control-label">code_id:</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-hdd"></i>
									</span>
									<input type="text" id="code_id" 
										class="form-control1" placeholder="请输入码支付id."
										onfocus="on_focus('code_id', '请输入码支付id.')"
										onblur="on_blur('code_id')">
								</div>
							</div>
							<div class="col-sm-2" id="codeId_validate">
								<p class="help-block" style="color: red;">*</p>
							</div>
						</div>
						</br>
						<div style="height: 40px;">
							<label class="col-md-2 control-label">通信密钥:</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-inbox"></i>
									</span>
									<input type="text" id="code_key" 
										class="form-control1" placeholder="请输入通信密钥."
										onfocus="on_focus('code_key', '请输入通信密钥.')"
										onblur="on_blur('code_key')">
								</div>
							</div>
							<div class="col-sm-2" id="code_key_validate">
								<p class="help-block" style="color: red;">*</p>
							</div>
						</div>
						</br>
						<div style="height: 40px;">
							<label class="col-md-2 control-label">通知地址:</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"> <i
									...
									<input type="text" id="notify_url" 
										class="form-control1" placeholder="请输入通知地址."
										onfocus="on_focus('notify_url', '请输入通知地址.')"
										onblur="on_blur('notify_url')">
								</div>
							</div>
						</div>
						</br>
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="text" id="token" 
										class="form-control1" placeholder="请输入token."
										onfocus="on_focus('token', '请输入token.')"
										onblur="on_blur('token')">
								</div>
							</div>
							<div class="col-sm-2" id="token_validate">
								<p class="help-block" style="color: red;">*</p>
							</div>
						</div>
						</br>
	...
	<script
		src="${pageContext.request.contextPath}/javascript/codePaySetUp.js"></script>
