...
import com.xiaoxiaowang.service.ActivityService;
...
public class ActivityServiceImpl extends ICommServiceImpl implements ActivityService {
	...
	/*
	 * 获取活动列表(non-Javadoc)
	 * @see com.xiaoxiaowang.service.ActivityService#getActivityList(int)
	 */
	@Override
	 ...
	 * @see com.xiaoxiaowang.service.ActivityService#saveOrUpdateDetail(java.lang.Integer, int, java.lang.String, int, int)
	 */
	@Override
	...
	/*
	 * 删除奖品(non-Javadoc)
	 * @see com.xiaoxiaowang.service.ActivityService#delActivityDetail(int)
	 */
	@Override
