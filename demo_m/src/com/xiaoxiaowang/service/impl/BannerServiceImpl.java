...
import com.xiaoxiaowang.service.BannerService;
...
public class BannerServiceImpl extends ICommServiceImpl implements
	 ...
	 * @see com.xiaoxiaowang.service.BannerService#bannerEnableOrDisable(int)
	 */
	@Override
	...
	/*
	 * 删除数据(non-Javadoc)
	 * @see com.xiaoxiaowang.service.BannerService#delBannerById(int)
	 */
	@Override
	 ...
	 * @see com.xiaoxiaowang.service.BannerService#addOrUpdateBanner(java.lang.Integer, java.lang.String, java.lang.String, int)
	 */
	@Override
