...
import com.xiaoxiaowang.util.ErrorMsgUtil;
...
public class BasicsMsgServiceImpl extends ICommServiceImpl implements
	 ...
	 * @return
	 * 
	 * @see com.xiaoxiaowang.service.BasicsMsgService#obtaionBasicsMsgList()
	 */
	@Override
...
//			sb.append("select b.kindid,b.appID,b.appsecret,b.wxtype from wx_basicsmsg b where b.wxtype=2 GROUP BY b.appID");
	...
	* @param token
	* @return
	* @see com.xiaoxiaowang.service.BasicsMsgService#obtainToken(java.lang.String)
	 */
	@Override
