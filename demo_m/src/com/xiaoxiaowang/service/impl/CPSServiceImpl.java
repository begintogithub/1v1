...
import com.xiaoxiaowang.service.CPSService;
import com.xiaoxiaowang.util.DateUtils;
import com.xiaoxiaowang.util.MessageUtil;
import com.xiaoxiaowang.util.PayUtil;
...
public class CPSServiceImpl extends ICommServiceImpl implements CPSService {
	...
	/*
	 * 结算CPS(non-Javadoc)
	 * @see com.xiaoxiaowang.service.CPSService#settlementCPS(int)
	 */
	@Override
	 ...
	 * 获取贡献列表
	 * (non-Javadoc)
	 * @see com.xiaoxiaowang.service.CPSService#getContributionList(int, int)
	 */
	@Override
