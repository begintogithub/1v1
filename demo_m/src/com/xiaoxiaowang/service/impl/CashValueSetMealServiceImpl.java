...
import com.xiaoxiaowang.service.CashValueSetMealService;
...
public class CashValueSetMealServiceImpl extends ICommServiceImpl implements
	 ...
	 * @see com.xiaoxiaowang.service.CashValueSetMealService#getCashValueList(int)
	 */
	@Override
	 ...
	 * @see com.xiaoxiaowang.service.CashValueSetMealService#addOrUpdateCashValue(java.lang.Integer, int, int, java.math.BigDecimal, int)
	 */
	@Override
	 ...
	 * 跟新数据状态
	 * (non-Javadoc)
	 * @see com.xiaoxiaowang.service.CashValueSetMealService#updateCashValueState(int, int)
	 */
	@Override
	...
	/*
	 * 删除数据(non-Javadoc)
	 * @see com.xiaoxiaowang.service.CashValueSetMealService#delCashValue(int)
	 */
	@Override
