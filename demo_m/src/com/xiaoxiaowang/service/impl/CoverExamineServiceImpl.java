...
import com.xiaoxiaowang.service.CoverExamineService;
...
public class CoverExamineServiceImpl extends ICommServiceImpl implements
	 ...
	 * 获取封面列表(non-Javadoc)
	 * 
	 * @see com.xiaoxiaowang.service.CoverExamineService#getCoverExamineList(int)
	 */
	@Override
	 ...
	 * 设置为主封面(non-Javadoc)
	 * 
	 * @see com.xiaoxiaowang.service.CoverExamineService#setUpFirst(int, int)
	 */
	@Override
	...
	/*
	 * 审核通过(non-Javadoc)
	 * @see com.xiaoxiaowang.service.CoverExamineService#throughAudit(int)
	 */
	@Override
