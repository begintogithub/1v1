...
import com.xiaoxiaowang.service.GiftService;
...
public class GiftServiceImpl extends ICommServiceImpl implements GiftService {
	...
	/*
	 * 列表(non-Javadoc)
	 * @see com.xiaoxiaowang.service.GiftService#getGiftList(int)
	 */
	@Override
	...
	/*
	 * 新增或修改(non-Javadoc)
	 * @see com.xiaoxiaowang.service.GiftService#addOrUpdateGift(java.lang.Integer, java.lang.String, java.lang.String, java.lang.String, int, java.lang.String)
	 */
	@Override
	...
	/*
	 * 删除礼物(non-Javadoc)
	 * @see com.xiaoxiaowang.service.GiftService#delGiftById(int)
	 */
	@Override
