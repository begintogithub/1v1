...
import com.xiaoxiaowang.service.GuildService;
...
public class GuildServiceImpl extends ICommServiceImpl implements GuildService {
	 ...
	 * @see com.xiaoxiaowang.service.GuildService#getGuildAnchorList(int, int)
	 */
	@Override
	...
	/*
	 * 公会移除主播(non-Javadoc)
	 * @see com.xiaoxiaowang.service.GuildService#delAnchor(int)
	 */
	@Override
	...
	/*
	 * 加入公会(non-Javadoc)
	 * @see com.xiaoxiaowang.service.GuildService#addGuild(int, java.lang.String)
	 */
	@Override
