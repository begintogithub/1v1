...
import com.xiaoxiaowang.service.LoginService;
...
public class LoginServiceImpl extends ICommServiceImpl implements LoginService {
    ...
    public MessageUtil login(String userName, String password, HttpServletRequest request) {
        ...
        System.out.println("密码密文：" + Md5Util.encodeByMD5(password));
     ...
     * @see com.xiaoxiaowang.service.LoginService#loginSetUpList()
     */
    @Override
     ...
     * @see com.xiaoxiaowang.service.LoginService#getLoginSetUpById(int)
     */
    @Override
     ...
     * @see com.xiaoxiaowang.service.LoginService#delLoginSteup(int)
     */
    @Override
     ...
     * @see com.xiaoxiaowang.service.LoginService#updateLoginState(int)
     */
    @Override
