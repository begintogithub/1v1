...
import com.xiaoxiaowang.service.OSSProjectService;
...
public class OSSProjectServiceImpl extends ICommServiceImpl implements
	 ...
	 * 
	 * @see com.xiaoxiaowang.service.OSSProjectService#jumpOssList()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.xiaoxiaowang.service.OSSProjectService#saveOrUpdateOssSetUp(java.lang.Integer
	 ...
	 * @see com.xiaoxiaowang.service.OSSProjectService#getOssDataById(int)
	 */
	@Override
	...
	/*
	 * 删除OSS对象(non-Javadoc)
	 * @see com.xiaoxiaowang.service.OSSProjectService#delOssSetUp(int)
	 */
	@Override
