...
import com.xiaoxiaowang.service.PutForwardService;
...
public class PutForwardServiceImpl extends ICommServiceImpl implements PutForwardService {
	 ...
	 * 获取提现统计(non-Javadoc)
	 * 
	 * @see com.xiaoxiaowang.service.PutForwardService#getPutForwardTotal()
	 */
	@Override
	 ...
	 * 修改提现状态(non-Javadoc)
	 * 
	 * @see com.xiaoxiaowang.service.PutForwardService#updatePutForwardState(int, int,
	 * java.lang.String)
	 */
	@Override
