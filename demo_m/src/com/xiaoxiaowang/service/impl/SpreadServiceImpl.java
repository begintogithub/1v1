...
import com.xiaoxiaowang.service.SpreadService;
import com.xiaoxiaowang.util.DateUtils;
import com.xiaoxiaowang.util.HttpContentUtil;
import com.xiaoxiaowang.util.Md5Util;
import com.xiaoxiaowang.util.MessageUtil;
import com.xiaoxiaowang.util.SystemConfig;
import com.xiaoxiaowang.util.ZxingUtils;
...
public class SpreadServiceImpl extends ICommServiceImpl implements SpreadService {
    ...
    public MessageUtil addSpreadUser(String loguser, String logpwd, int t_gold_proportions,
        ...
        try {
            ...
            List<Map<String, Object>> map = this.getFinalDao().getIEntitySQLDAO().findBySQLTOMap("SELECT * FROM t_spread_login WHERE t_user_name = ? AND t_pass_word = ? ", loguser, Md5Util.encodeByMD5(logpwd));
...
//				计算下一级的推广渠道用户消费金额
    ...
    public static void main(String[] args) throws IOException {
        String img_path = "http://t.cn/AiCdH22w";
        ...
        // 背景图片地址
        String backgroundPath = "/Users/x/Downloads/";

        if (Config().indexOf("Windows") > -1) {
            backgroundPath = backgroundPath + "11.png";
        } else {
            backgroundPath = backgroundPath + "11.png";
        }
...
//	            image = ZxingUtils.drawString(image, text, 375, 647,font,new Color(244,254,189));
            ...
            String fielName = "/Users/x/Downloads/".toString().split("/")[1];
