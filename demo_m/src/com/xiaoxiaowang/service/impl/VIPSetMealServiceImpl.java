...
import com.xiaoxiaowang.service.VIPSetMealService;
...
public class VIPSetMealServiceImpl extends ICommServiceImpl implements
	...
	/*
	 * 删除VIP套餐(non-Javadoc)
	 * @see com.xiaoxiaowang.service.VIPSetMealService#delVipSetMeal(int)
	 */
	@Override
	...
	/*
	 * 修改状态(non-Javadoc)
	 * @see com.xiaoxiaowang.service.VIPSetMealService#upEnableOrDisable(int, int)
	 */
	@Override
