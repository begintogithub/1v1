...
import com.xiaoxiaowang.service.VagueService;
...
public class VagueServiceImpl extends ICommServiceImpl implements VagueService {
	...
	/*
	 * 删除模糊认证(non-Javadoc)
	 * @see com.xiaoxiaowang.service.VagueService#delVagueById(int)
	 */
	@Override
	...
	/*
	 * 通过审核(non-Javadoc)
	 * @see com.xiaoxiaowang.service.VagueService#hasVerified(int)
	 */
	@Override
