package com.xiaoxiaowang.dao.impl;
...
import com.xiaoxiaowang.dao.core.BaseJdbcTemplate;
import com.xiaoxiaowang.dao.util.ArrayRowMapper;
...
public class IEntitySQLDAOImpl  extends BaseJdbcTemplate implements IEntitySQLDAO {
	...
	@Override
	public <T> List<T> findByPageSQL(String sql, int pageSize, int pageNo,
			Object... params) {
